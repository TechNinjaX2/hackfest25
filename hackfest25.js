 ...
 * - Backend endpoints for auth (SQLite) and route lookup (Google Directions API)
 * - No external "AI" dependency required: server picks fastest route from Google results.
 *
 * Setup:
 ...
 *
 * Notes:
 * - This is a starting scaffold. Add proper production hardening before deployment.
 * - Replace placeholder company name as needed.
 */
...
<body>
  ...
  <script>
    ...
    hamburger.addEventListener('click', ()=> sidePanel.classList.toggle('open'));
    ...
    // Map + routing behavior (keeps existing functionality)
